...
_Note that everything will feel very sluggish as [S3 populates the SSD](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ebs-initialize.html). Once this happens, everything will be much faster._
