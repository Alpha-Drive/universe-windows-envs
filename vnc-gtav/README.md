...
_Note everything will feel very as [S3 populates the SSD](http://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ebs-initialize.html). Once this happens, everything will be much faster._
